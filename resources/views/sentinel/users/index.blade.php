            ...
            @foreach ($users as $user)
                <tr>
                    ...
                    <td>
                        ...
                        @if (file_exists('result/'.$user->email.'.pdf'))
                        <button type="button" onClick="location.href='{{ URL::to('result') }}/{{ $user->email }}.pdf'" class="btn red lighten-1">See Result</button>
                        @else
                        <button type="button" onClick="location.href='{{ URL::to('result') }}/{{ $user->email }}.pdf'" class="btn disabled">See Result</button>
                        @endif
